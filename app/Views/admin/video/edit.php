        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <form id="quickForm" method="post" action="/admin/video/edit/<?= $video['id'] ?>" enctype="multipart/form-data">
                <?= csrf_field() ?>
                ...
                <div class="card-body">
                  ...
                  <div class="form-control" style="height: auto;">
                    <div id="image-holder">
                      <?= img(['src' => '/uploads/video/'.$video['image'], 'width' => '300', 'style' => '']) ?>
                    </div>
                  </div>
                  
                  <div class="form-group">
                    <label for="exampleInputEmail1">Nhúng video</label>
                    <textarea class="form-control" name="content"><?= esc($video['content']) ?></textarea>
                  </div>
