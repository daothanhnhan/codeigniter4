        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <form id="quickForm" method="post" action="/admin/menu/edit/<?= $menu['id'] ?>" enctype="multipart/form-data">
                <?= csrf_field() ?>
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="name" value="<?= esc($menu['name']) ?>" class="form-control" id="" placeholder="" required="">
                  </div>

                  <?= view_cell('MenuCell', ['menu_id' => $menu['id'], 'action' => 'edit']) ?>
                  ...
                  <div class="form-group">
                    ...
                    <select name="type" class="form-control" onchange="chon_type(value)">
                      ...
                      <option value="<?= $menu_type['model'] ?>" <?= $menu_type['model']==$menu['type'] ? 'selected' : '' ?> ><?= $menu_type['name'] ?></option>
                      <?php endforeach ?>
                    </select>
                  </div>
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" name="sort" value="<?= esc($menu['sort']) ?>" class="form-control" id="" placeholder="" required >
                  </div>
                </div>
