        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="quickForm" method="post" action="/admin/user/add">
              	<?= csrf_field() ?>
                <div class="card-body">
                	<div class="form-group">
                    <label for="exampleInputUsername">UserName</label>
                    <input type="text" name="username" value="<?= old('username') ?>" class="form-control" id="exampleInputUsername" placeholder="Enter username" required="">
                  </div>
                  <div class="form-group">
